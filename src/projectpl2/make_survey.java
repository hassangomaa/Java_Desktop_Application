 ...
 * @author khale
 */
public class make_survey extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        PANELLL.setBackground(new java.awt.Color(51, 51, 51));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(make_survey.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new make_survey().setVisible(true);
            }
        });
    }
