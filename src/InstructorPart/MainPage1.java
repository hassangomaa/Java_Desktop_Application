...
public class MainPage1 {
    ...
    TextArea showMsg;
    JLabel label = new JLabel(),label2 = new JLabel("Statistics of Top 10 Students"),label4,label3 = new JLabel(new ImageIcon("G:\\C O D E\\java\\courses\\src\\InstructorPart\\writing.png"));
    ...
    CourseModel.DATABASE db = new CourseModel.DATABASE("root","courses");
    ...
    public void showUserIcon(){
        label4 = new JLabel("user : " + Framess.FirstFrm.txtFiledUsername.getText());
        frame.add(label3);
